...
# This script installs puppet 3.x and deploy the manifest using puppet apply -e "include role_lb"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/role_lb/master/files/bootme.ps1')) -ArgumentList ("role_lb")
#</powershell>
  ...
  $puppet_source = "https://github.com/relybv/dirict-role_lb.git"
