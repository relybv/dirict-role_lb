...
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/pgomersbach/role_lb/master/files/bootme.sh; bash bootme.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/pgomersbach/role_lb/master/skeleton/files/bootme.sh -o bootme.sh; bash bootme.sh
...
puppet apply -e "include role_lb"
