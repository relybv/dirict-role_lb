...
4. [Setup - The basics of getting started with role_lb](#setup)
    * [What role_lb affects](#what-role_lb-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with role_lb](#beginning-with-role_lb)
